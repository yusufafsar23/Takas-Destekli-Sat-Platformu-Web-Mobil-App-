...
const ProductDetail = () => {
  ...
  useEffect(() => {
    if (user && product && product.owner) {
      // Daha detaylı debug - owner nesnesinin tüm özelliklerini yazdır
      console.log("PRODUCT OWNER DETAILS:", {
        owner: product.owner,
        ownerKeys: Object.keys(product.owner),
        ownerValues: Object.values(product.owner),
        user: user,
  ...
  return (
    <Container className="py-4 product-detail">
      <Row>
        <Col md={6}>

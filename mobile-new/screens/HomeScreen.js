...
const HomeScreen = ({ navigation }) => {
  ...
  const renderProductItem = ({ item }) => (
    ...
    >
      <Card
        ...
        price={item.price}
        tradeOnly={item.tradeOnly}
        acceptsTradeOffers={item.acceptsTradeOffers}
      />
    </TouchableOpacity>
  );
  ...
  const renderSmallProductItem = (product) => {
    ...
    const formatPrice = () => {
      ...
      if ((!product.price || product.price === 0) && product.acceptsTradeOffers) {
        return 'Sadece Takas';
      }
      ...
      >
        <View style={styles.smallerCard}>
          ...
          <View style={styles.smallerCardContent}>
            ...
            <Text style={styles.smallerCardPrice}>{formatPrice()}</Text>
          </View>
        </View>
      </TouchableOpacity>
    );
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Takas Platform</Text>
      </View>
          ...
          <View style={styles.productsContainer}>
            {featuredProducts.map((product) => (
              <Card
                ...
                style={styles.productCard}
                tradeOnly={product.tradeOnly}
                acceptsTradeOffers={product.acceptsTradeOffers}
                onPress={() => goToProductDetail(product.id)}
              />
            ))}
          </View>

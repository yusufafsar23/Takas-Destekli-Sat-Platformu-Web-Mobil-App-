...
const ProductDetailScreen = ({ route, navigation }) => {
  ...
  const formatPrice = (price) => {
    ...
    if ((!price || price === 0) && product && product.acceptsTradeOffers) {
      return 'Sadece Takas';
    }
          ...
          <>
            ...
            {product.acceptsTradeOffers && (
              <View style={styles.tradeOption}>
                ...
                <Text style={styles.tradeOptionText}>Takas Kabul Edilir</Text>
              </View>
            )}
            
            {product.tradeOnly && (
              <View style={styles.tradeOption}>
                <Ionicons name="swap-vertical" size={16} color="#FF6B6B" />
                <Text style={styles.tradeOptionText}>Sadece Takas</Text>
              </View>
            )}
